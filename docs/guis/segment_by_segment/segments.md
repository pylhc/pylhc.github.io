...
To load (additional) measurements, click the `Load` button in the side panel to open a file dialogue and select the measurement folder corresponding to the optics analysis to be loaded.
