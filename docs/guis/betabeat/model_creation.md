...
- **Year/Tag**:
This field is automatically filled by the first layer of subfolders in the `acc-models/lhc` repository by the fetcher.
- **Energy**:
...
- **Year**:
This field is automatically filled by the first layer of subfolders in the `acc-models/sps` repository.
- **Strength File**:
