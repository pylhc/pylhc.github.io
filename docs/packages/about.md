...
An overview of our main packages and relevant links can be found in the table below.
...
| [**OMC3 GUI**][omc3_gui]{target=\_blank}                 | Graphical User Interface for OMC3 Segment-by-Segment Analysis                                                | [![PyPI version for OMC3 GUI](https://img.shields.io/pypi/v/omc3_gui.svg)][omc3_gui_pypi]{target=\_blank}                         | [:fontawesome-solid-book:][omc3_gui_doc]{target=\_blank}         | [:fontawesome-solid-circle-question:](../guis/segment_by_segment/gui.md) |
...
| [**Example Study Scripts**][mess]{target=\_blank}                             | Collection of example MAD-X studies                                                        | [![GitHub release for MESS](https://img.shields.io/github/v/release/pylhc/MESS?color=orange&label=Release&logo=Github)][mess_releases]{target=\_blank}                                 |                                                                       |                                                                        |
