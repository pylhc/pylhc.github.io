...
*[HL-LHC Optics Part II]: Measurements through the squeeze, with arc bumps and global corrections from flattop. Improved beta-beating with global corrections and local arc bumps for first matchpoints. High beta-beating (>50%) for both beams during the last steps (at 1.15m/0.45m). Beam dumped during squeeze to 37cm.
